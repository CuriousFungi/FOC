...
#define DEF_PID_CURR_I 100.0f //!<  default PID controller I value
...
// align voltage
#define DEF_VOLTAGE_SENSOR_ALIGN 12.9f   //3.0f //!< default voltage for sensor and motor zero alignemt
// low pass filter velocity
#define DEF_VEL_FILTER_Tf 0.005 //!< default velocity filter time constant  // TODO: this is overriding earlier def
